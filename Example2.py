...
for i, num_samples in enumerate(num_samples_list):
    for j, activationFn in enumerate(activationFn_list):
        ...
        axs[i, j].set_title(f'Num Samples: {num_samples}, {activationFn.__name__} Activation Function')
        axs[i, j].legend()

plt.savefig('Example2.pdf', dpi=300, bbox_inches='tight', pad_inches=0.1)
plt.savefig('Example2.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
plt.show()
